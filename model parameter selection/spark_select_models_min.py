...
"""
Spark Multi-Model Parameter Selection - master_df.csv data (MIN)
...
Usage:
Local run:
    spark-submit spark_select_models_min.py \
      --input output/master_parquet \
      --output output/select_models_min

Dataproc:
    gcloud dataproc jobs submit pyspark spark_select_models_min.py \
      --cluster=<cluster-name> \
      --region=us-east1 \
      -- --input gs://bucket/output/master_parquet \
         --output gs://bucket/output/select_models_min
"""
